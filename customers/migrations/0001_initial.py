        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "debit",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Debit"
                    ),
                ),
                (
                    "credit",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Credit"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Auto-generated customer code (e.g., CUST001)",
                        max_length=50,
                        null=True,
                        unique=True,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="regular",
                        help_text="Customer type classification",
                        max_length=20,
                ...
                (
                    ...
                    models.DateField(
                        auto_now_add=True,
                        help_text="Date of customer's last visit",
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=customers.models.upload_to_customer,
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True,
                        help_text="Special preferences, allergies, etc.",
                        max_length=1000,
                        null=True,
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["customer_code"], name="customers_c_custome_116ac0_idx"
                    ),
                    models.Index(
                        fields=["phoneNumber"], name="customers_c_phoneNu_150b0c_idx"
                    ),
                    models.Index(fields=["email"], name="customers_c_email_4fdeb3_idx"),
                    models.Index(
                        fields=["category"], name="customers_c_categor_f85c24_idx"
                    ),
                    models.Index(
                        fields=["status"], name="customers_c_status_ce44cf_idx"
                    ),
                    models.Index(
                        fields=["lastVisit"], name="customers_c_lastVis_31d8fa_idx"
                    ),
                ],
            },
        ),
