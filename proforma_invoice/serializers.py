...
class ProformaInvoiceItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "product", "unit", "qty", "rate", "discount_percent",
            "discount_amount", "product_total", "amount", "tax_percent",
            "tax_amount", "total", "si_no", "product_name", "unit_name",
        ]
...
class ProformaInvoiceListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "po_ref", "total", "tax_total", "discount", "grand_total",
            "tax_mode", "type",
...
class ProformaInvoiceDetailSerializer(serializers.ModelSerializer):
    items = ProformaInvoiceItemSerializer(many=True, read_only=True)
    customer_name = serializers.SerializerMethodField()
    currency_code = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            "financial_year", "date", "due_date", "sales_person", "sales_person_name",
            "type", "location", "attention", "narration", "tax_mode",
            "po_ref", "project_ref_no", "enable_seal_and_sign",
            "invoice_period", "supply_date", "bank_account", "bank_account_name",
            "payment_terms",
            "total", "tax_total", "discount", "grand_total",
...
class ProformaInvoiceItemWriteSerializer(serializers.Serializer):
...
class ProformaInvoiceWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "date", "due_date", "sales_person", "type",
            "location", "attention", "narration", "tax_mode",
            "po_ref", "project_ref_no", "enable_seal_and_sign",
            "invoice_period", "supply_date", "bank_account", "payment_terms",
            "total", "tax_total", "discount", "grand_total",
            "attachment", "attachment_name", "products",
        ]
        extra_kwargs = {
            ...
            "supply_date": {"required": False, "allow_null": True},
    ...
    def validate(self, attrs):
        ...
        if cr is not None and cr <= 0:
            raise serializers.ValidationError(
                {"currency_rate": "Currency Rate must be greater than 0."}
            )
        return attrs
