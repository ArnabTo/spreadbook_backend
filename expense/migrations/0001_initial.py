    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(help_text="Expense description", max_length=500),
                ),
                (
                    "vendor",
                    models.CharField(
                        help_text="Vendor or supplier name", max_length=200
                    ),
                ),
                (
                    "amount",
                ...
                (
                    "due_date",
                    models.DateField(
                        blank=True, help_text="Due date for payment", null=True
                    ),
                ),
