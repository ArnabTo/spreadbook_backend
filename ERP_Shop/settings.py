...
LOCAL_APPS = [
    ...
    "delivery_note.apps.DeliveryNoteConfig",
    "sales_invoice.apps.SalesInvoiceConfig",
    "proforma_invoice.apps.ProformaInvoiceConfig",
    "sales_return.apps.SalesReturnConfig",
...
DEFENDER_REDIS_URL = (
    os.getenv("DEFENDER_REDIS_URL")
    or os.getenv("DJANGO_REDIS_URL")
