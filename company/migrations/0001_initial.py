        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "avatarUrl",
                    models.ImageField(
                        blank=True, null=True, upload_to=company.models.upload_to
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Alternative phone field",
                        max_length=20,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Alternative address field",
                        max_length=200,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Number of branches (stored field)",
                        null=True,
                    ),
                ),
                (
                    "activeUsers",
                    models.IntegerField(
                        blank=True, help_text="Number of active users", null=True
                    ),
                ),
                (
                    "monthlyRevenue",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Date when company was approved/rejected",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "initialPaymentDate",
                    models.DateTimeField(
                        blank=True, help_text="Date of initial payment", null=True
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Branch name (e.g., Downtown Branch, Mall Location)",
                        max_length=100,
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        help_text="Unique branch code (e.g., DT001, ML002)",
                        max_length=20,
                        unique=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Frontend location field",
                        max_length=200,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0.0,
                        help_text="Today's sales amount",
                        max_digits=10,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0.0,
                        help_text="Current month's sales",
                        max_digits=10,
                    ),
                ),
                (
