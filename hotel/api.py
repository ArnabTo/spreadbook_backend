...
class RoomTypeViewSet(BranchFilteredQuerysetMixin, viewsets.ModelViewSet):
...
class RoomViewSet(BranchFilteredQuerysetMixin, viewsets.ModelViewSet):
...
class StayReservationViewSet(BranchFilteredQuerysetMixin, viewsets.ModelViewSet):
    queryset = StayReservation.objects.select_related(
    ...
    def check_in(self, request, pk=None):
        ...
        # Ensure a folio exists for billing
