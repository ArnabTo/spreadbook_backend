...
class Calendar(models.Model):
    ...
    start = models.ImageField(default=0, blank=True, null=True)
    end = models.ImageField(default=0, blank=True, null=True)
    slug = models.SlugField(_("slug"), max_length=200, unique=True)
    # objects = CalendarManager()

    class Meta:
        verbose_title = _("calendar")
        verbose_title_plural = _("calendars")
...
class CalendarRelation(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["content_type", "object_id"], name="calrel_content_type_obj_idx"
            ),
        ]
