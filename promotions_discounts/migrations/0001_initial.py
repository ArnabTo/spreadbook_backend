    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Name of the promotion", max_length=200),
                ),
                (
                    "type",
                    models.CharField(
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Promotional code for customers",
                        max_length=50,
                        unique=True,
                    ),
                ),
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of the promotion"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="promotions_discounts.promotion",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                fields=["start_date", "end_date"], name="promotions__start_d_85ec66_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                fields=["company"], name="promotions__company_ae61cf_idx"
            ),
        ),
    ]
